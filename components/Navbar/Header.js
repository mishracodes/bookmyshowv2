...
const Header = () => {
  ...
  return (
    <>
    <div className='h-12 sm:h-16 w-full bg-[#333545]'>
      <div className='max-w-7xl mx-auto h-full flex items-center justify-between gap-10 px-4'>
        <div className='flex gap-4 flex-grow'>
          ...
          <div className='hidden md:flex rounded-sm bg-gray-100 flex-grow px-2 items-center py-1 max-w-[549px]'>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 cursor-text" onClick={() => searchRef.current.focus()}>
              <path fillRule="#454545" d="M10.5 3.75a6.75 6.75 0 100 13.5 6.75 6.75 0 000-13.5zM2.25 10.5a8.25 8.25 0 1114.59 5.28l4.69 4.69a.75.75 0 11-1.06 1.06l-4.69-4.69A8.25 8.25 0 012.25 10.5z" clipRule="evenodd" />
            </svg>
            <input ref={searchRef} type='text' className='bg-gray-100 outline-none px-1  text-sm' placeholder='Search for movies and activities' />
          </div>


        </div>
        <div className='flex gap-3 text-white'>
          <div className='hidden sm:flex text-sm font-medium items-center'>
            Bengaluru
          ...
          <div className='bg-[#f84464] h-[25px] w-[67px] hidden sm:flex items-center justify-center rounded-md text-xs'>
            Sign in
          </div>
  ...
  <path fillRule="evenodd" d="M3 6.75A.75.75 0 013.75 6h16.5a.75.75 0 010 1.5H3.75A.75.75 0 013 6.75zM3 12a.75.75 0 01.75-.75h16.5a.75.75 0 010 1.5H3.75A.75.75 0 013 12zm0 5.25a.75.75 0 01.75-.75h16.5a.75.75 0 010 1.5H3.75a.75.75 0 01-.75-.75z" clipRule="evenodd" />
    ...
    <div className='hidden md:block bg-[#1f2533] w-full h-[40px] text-white'>
